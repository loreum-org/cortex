...
export default function Staking() {
  ...
  const formatTokenAmount = (amount: string): string => {
    try {
      ...
      return num.toFixed(4).replace(/\.?0+$/, '') + ' LORE';
    } catch {
      return '0 LORE';
    }
  };
      ...
      {showStakeForm && (
        <div className="fixed inset-0 bg-tesla-black bg-opacity-90 flex items-center justify-center z-50">
          <div className="bg-tesla-dark-gray border border-tesla-border p-6 w-full max-w-md">
            <h3 className="text-lg font-medium text-tesla-white mb-6 uppercase tracking-wider">STAKE LORE TO NODE</h3>
        ...
        <div className="grid md:grid-cols-2 gap-8 text-xs">
          <div>
            ...
            <ul className="space-y-2 text-tesla-text-gray">
              <li>• STAKE LORE TOKENS TO NODES TO BOOST THEIR REPUTATION</li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-tesla-text-gray">
              <li>• MINIMUM STAKE: 10 LORE PER NODE</li>
              <li>• MAXIMUM STAKE: 10,000 LORE PER NODE</li>
