...
export function Wallet() {
  ...
  const handleTransfer = async (e: React.FormEvent) => {
    ...
    // Convert amount to smallest unit (assuming 18 decimals like λore)
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8 space-y-8 bg-tesla-black">
          ...
          >
            <div className="space-y-3">
              <div className="text-2xl font-light text-tesla-accent-red">
                ...
                {(parseFloat(state.account.total_spent) / 1e18).toFixed(4)} λore
              </div>
              <div className="text-xs text-tesla-text-gray uppercase tracking-wider">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Transfer Form */}
        <MetricCard title="Send λore" icon={<Send className="h-6 w-6" />}>
          <form onSubmit={handleTransfer} className="space-y-6">
            ...
            >
              ...
              {state.transferLoading ? 'SENDING...' : 'SEND λore'}
            </button>
          </form>
        </MetricCard>
                ...
                >
                  ...
                  <div className="text-right">
                    <div className={`font-medium text-sm ${
                      ...
                      {(parseFloat(tx.amount) / 1e18).toFixed(4)} λore
                    </div>
